...
public class AuthorizationFilterSecurity extends BasicAuthenticationFilter {

	Environment environment;

	public AuthorizationFilterSecurity(AuthenticationManager authManager, Environment environment) {
		super(authManager);
